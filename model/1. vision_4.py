...
x_train = train.drop(['id', 'letter'], axis=1)

def select_index(column, x):
    a = x_train[x_train[column].isin([x])]
    x = a.iloc[:,1:]
    y = a.iloc[:,0]
...
x0, y0 = select_index("digit", "0")
x1, y1 = select_index("digit", "1")
x2, y2 = select_index("digit", "2")
x3, y3 = select_index("digit", "3")
x4, y4 = select_index("digit", "4")
x5, y5 = select_index("digit", "5")
x6, y6 = select_index("digit", "6")
x7, y7 = select_index("digit", "7")
x8, y8 = select_index("digit", "8")
x9, y9 = select_index("digit", "9")
